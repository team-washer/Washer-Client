...
export default function AdminPage() {
  ...
  //                     onValueChange={(value) => setDeviceTypeFilter(value)}
  //                   >
  //                     <SelectTrigger>
  //                       <SelectValue />
  //                     </SelectTrigger>
  ...
  //                     onValueChange={(value) => setUserGenderFilter(value)}
  //                   >
  //                     <SelectTrigger>
  //                       <SelectValue />
  //                     </SelectTrigger>
  ...
  //                     onValueChange={(value) => setUserFloorFilter(value)}
  //                   >
  //                     <SelectTrigger>
  //                       <SelectValue />
  //                     </SelectTrigger>
  ...
  //                 onValueChange={(value) => setSelectedReportStatus(value)}
  //               >
  //                 <SelectTrigger>
  //                   <SelectValue />
  //                 </SelectTrigger>
  ...
  //                 onValueChange={(value) => setRestrictionDuration(value)}
  //               >
  //                 <SelectTrigger>
  //                   <SelectValue />
  //                 </SelectTrigger>
