...
import { roleManager, securityManager } from '@/shared/lib/auth-utils';
import {
  machineApi,
  reservationApi,
  userApi,
...
export default function AdminPage() {
  ...
  const [deviceTypeFilter, setDeviceTypeFilter] = useState<
    'all' | 'washer' | 'dryer'
  >('all');
  const [floorFilter, setFloorFilter] = useState<'all' | '3F' | '4F' | '5F'>(
    'all'
  );
                    ...
                    {adminReservations.slice(0, 5).map((reservation) => (
                      ...
                      >
                        <div>
                          ...
                          <p className='text-xs text-gray-500'>
                            남은 시간:{' '}
                            {formatTime(reservation.remainingSeconds)}
                          </p>
                        </div>
                        <Badge
                          variant={
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: any) => setDeviceTypeFilter(value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      value={floorFilter}
                      onValueChange={(value: any) => setFloorFilter(value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: any) => setUserGenderFilter(value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: any) => setUserFloorFilter(value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: any) => setSelectedReportStatus(value)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value: any) => setRestrictionDuration(value)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
