...
import { Shirt, Clock, MapPin, AlertTriangle, CheckCircle, Loader2, Home, RefreshCw } from "lucide-react"
            ...
            <div key={floor} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h3 className="text-lg font-semibold text-[#6487DB] dark:text-white">{floor}층 세탁기</h3>
