...
export function ReportMachineModal({ machineName, machineType }: ReportMachineModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        title: "신고 접수 완료",
        description: "고장 신고가 접수되었습니다. 빠른 시일 내에 처리하겠습니다.",
      })
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {machineName} {machineType === "washing" ? "세탁기" : "건조기"}의 고장을 신고합니다.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            ...
            <Input id="machine-name" value={machineName} disabled className="bg-gray-50" />
          </div>
          ...
          <div className="grid gap-2">
            ...
            <p className="text-xs text-gray-500">
              예: 세탁기가 돌아가지 않아요, 물이 빠지지 않아요, 이상한 소리가 나요 등
            </p>
          </div>
        </div>
